...
class SettingsCommsRoom extends StatefulWidget {
  const SettingsCommsRoom({super.key});

  @override
  State<SettingsCommsRoom> createState() => _SettingsCommsRoomState();
}

class _SettingsCommsRoomState extends State<SettingsCommsRoom> {
  bool _autoDialEmergency = true;
  bool _shareGpsOnSos = true;
  bool _speakIncomingSms = true;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SwitchListTile(
                        ...
                        value: _autoDialEmergency,
                        onChanged: (v) =>
                            setState(() => _autoDialEmergency = v),
                      ),
                      ...
                      SwitchListTile(
                        ...
                        activeColor: AppTheme.errorRed,
                        value: _shareGpsOnSos,
                        onChanged: (v) => setState(() => _shareGpsOnSos = v),
                      ),
                      const Divider(color: AppTheme.softBorder),
                      SwitchListTile(
                        contentPadding: EdgeInsets.zero,
                        ...
                        value: _speakIncomingSms,
                        onChanged: (v) => setState(() => _speakIncomingSms = v),
                      ),
